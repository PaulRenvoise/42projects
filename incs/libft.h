...
/*   Updated: 2014/03/25 19:49:18 by prenvois         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_lstnew_or_add(t_list **alst, void const *content,
					size_t size, int call);
...
void				ft_llstnew_or_add(t_llist **allst, void const *content,
					size_t size, int call);
...
void				ft_cllstnew_or_add(t_node **root, void const *content,
					size_t size, int call);
...
void				ft_bnew_or_add(t_btree **abtree, void const *content,
					size_t size, int side);
